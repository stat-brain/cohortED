...
![](assets/img/visualizing_change.png){alt="Screenshot of example report showing new plotting capabilities" style="width: 90%"}
...
![](assets/img/bolster_reporting.png){alt="Screenshot of example report showing automatically generated text" style="width: 90%"}

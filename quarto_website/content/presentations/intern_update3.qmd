...
::: {.column width="40%"}
<img src="assets/img/watch.jpg" alt="Refined Watch Gears Image"
     style="max-width: 100%; max-height: 400px; height: auto; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.2);">
:::
...
::: {.column width="40%"}
<img src="assets/img/code_image.jpg" alt="Image of Computer Code"
     style="max-width: 100%; max-height: 400px; height: auto; border-radius: 8px; box-shadow: 0 4px 10px rgba(0,0,0,0.2);">
:::
...
<div style="text-align: center; margin-top: 3rem;">
  <a href="https://stat-brain.github.io/cohortED/example_reports.html"
     target="_blank"
     style="
     ...
     "
     onmouseover="this.style.backgroundColor='#005f99'; this.style.transform='scale(1.06)'"
     onmouseout="this.style.backgroundColor='#007acc'; this.style.transform='scale(1.0)'">
    📄 View Example Reports
  </a>
</div>
